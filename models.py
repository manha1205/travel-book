...
class User(db.Model):
    ...
    sign_in_code = db.Column(db.String(15), unique = True, nullable = False, default= lambda: str(uuid.uuid4()))
...
trip_participants = db.Table("trip participants", db.Column('trip_id', db.Integer, db.ForeignKey('trip.id') ), db.Column('user_id', db.Integer, db.ForeignKey('user_id')))
